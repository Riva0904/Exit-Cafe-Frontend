...
export function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto flex max-w-xl flex-col items-center px-4 py-24 text-center">
        ...
        <h1 className="font-display mt-6 text-2xl font-bold text-cream-100">Your cart is empty</h1>
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="font-display mb-8 text-3xl font-bold text-cream-100">Your Cart</h1>
